...
const Hero = () => {
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: "polygon(14% 0%, 72% 0%, 90% 88%, 0% 95%)",
  ...
  return (
    <div className="relative w-screen h-dvh overflow-x-hidden">
      ...
      <div
        id="video-frame"
        className="relative overflow-hidden w-screen h-dvh z-10 rounded-lg bg-blue-75"
      >
        <div>
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-blue-100">
              Unleash the Metagame Layer <br /> Unleash the Play Economy
            </p>
            <Button
              id="watch-trailer"
              title="watch trailer"
